...
class StrategyRdSupervisor:
    ...
    def evaluate_strategy(self, strategy: Dict[str, Any], backtest_result: Dict[str, Any]) -> bool:
        """评估策略 - 判断是否接受优化建议"""
    ...
    def should_continue(
        ...
        """判断是否继续迭代"""
        from .strategy_rd_supervisor_prompt import strategy_rd_supervisor_continue_prompt
        ...
        try:
            ...
            LOGGER.info(f"监督器决策: {'继续' if should_continue else '停止'}, 原因: {result.get('reason', '')}")
