...
3. 读取 `AGENTS.md` 的「开发待办 (TODO)」章节 —— 这是待完成功能清单。
...
2. **推进 AGENTS.md TODO 清单**中未勾选的项，按文档顺序逐个完成。每完成一项，在 `RALPH_PROGRESS.md` 记录：日期、项名、改动文件、验证结果。
...
- 所有新代码遵循 AGENTS.md 编码规范（Python 3.11 严格、类型注解、中文注释、依赖注入、88 字符行宽、McCabe ≤15）。
